...
is uncrossed. `split_block_columns()` is still in `r010_ocr_blocks.py`, unwired. **Superseded** --
...
guarded now; `r020_evaluate.py` refuses to score pages that were never classified.
