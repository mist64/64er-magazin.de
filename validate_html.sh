...
DIRECTORY_PATH="out"
REGEXP=".*(Trailing.slash|An..img..element.must.have.an..alt..attribute|character.in.path.segment..space.is.not.allowed|Consider.adding.a..lang.|Consider.using.the..h1..element.as.a.top.level.heading.only).*"
