...
x = 0 linker Randausgleich, x = 1 rechter Randausgleich (der Text wird rechtsbündig gedruckt), x = 2 alle Zeilen werden auf die Mitte zentriert, x = 3 Blocksatz (linker und rechter Randausgleich).
