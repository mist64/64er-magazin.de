...
Auf dem Bildschirm soll also folgendes erscheinen: »Wollen Sie weitermachen (Ja/Nein)? Ja«
...
Der Befehlsaufruf kann zum Beispiel lauten: input'mit'vorgabe("Was nun? "," ",eingabe$)
...
uauff$="Wollen Sie weitermachen":uvorg$="JA"
...
100 rem sequenz
110   uauff$="Wollen Sie weitermachen?":uvorg$="Ja"
