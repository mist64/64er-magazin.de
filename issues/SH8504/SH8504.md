...
Listing der 80-Zeichen-Softwarekarte. Beachten Sie bitte bei der Eingabe den MSE.
82
Grafik
...
Listing der 80-Zeichen-Softwarekarte (Fortsetzung).
...
Listing der 80-Zeichen-Softwarekarte (Schluß). Beachten Sie bitte bei der Eingabe den MSE.
...
116 117	PRINT TAB(ll);"<DOWN>-1- SÄTEN EINGEBE N" PRINT TAB(ll);"<DOWN>-2- DATEN LADEN”	<099> <049>
...
165	FL(Q,W)=T	<097>
166	IF T=0 THEN R=l:PF(Q)=W-1:NEXT	<018>
167	NEXT:PF(Q)=8	<111>
...
177	REM *******************************	<059>
178	FU$="DATEN LADEN ($=SIR)":GOSUB 124	<184>
...
243	F=0	<164>
244	GOTO 247	<212>
245	INPUT” <DOWN>FLUGPUNKT-XY/ZOR. <3SPACE>0,0, 25 <8LEFTJ";FX,FY,FZ	<127>
...
Editieren von Programmen • Fehlersuche und -korrektur • Diskettenoperationen • Zahlentypen • Grundlagen des strukturierten Programmierens • der FORTH-Standard • FORTH-79 und Erweiterungen • mit ausführlichem Glossar • FORTH — die Sprache für alle, die mehr aus ihrem Computer rausholen wollen!
...
370 VN=32:DIM P7.(VN-1,2)
380 FOR N=0 TO VN-1:READ P7.(N,0),P7.(N,l),P
7.(N,2):NEXT
390 :
...
NEXT:S=119/Y	<075>
FOR N=0 TO VN-1:PX(N,l)=S*PX(N,l)+YC:P
